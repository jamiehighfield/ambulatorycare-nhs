...
-- Liquid Intake
INSERT INTO liquid_intake (`FK_patient_id`, `date_time`, `title`, `amount`)
	VALUES (1, '2019-01-02 07:22:00', 'Water', 200);
...
-- Dev Login Username: Dev Password: Wee
INSERT INTO accounts ( `FK_patient_id`, `username`, `password_hash`, `first_name`, `last_name`, `email_address`, `FK_security_question_id`, `answer_hash`, `account_type`, `deleted`)
VALUES (1, 'Dev', '$2a$10$l89ZNoGGghWFhJV2A3H7ZuvqF88LK54vd.6fPsuYCls6cFcX8qg1y', 'Dev2', 'Team', 'team@dev.co.uk', 1, '123' , 1, null);